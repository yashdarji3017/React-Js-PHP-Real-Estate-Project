...
$result = mysqli_query($conn,"select * from architech where architech_id='$uid' and otp='$otp'") or die(mysqli_error($conn));
...
if(!$mail->send()) { 
  //  echo 'Message could not be sent. Mailer Error: '.$mail->ErrorInfo; 
   ...
   // echo 'Message has been sent.'; 
    ...
    mysqli_query($conn,"update architech set verify='Yes' where architech_id='$uid'");
    echo "Yes";
}
else
{
