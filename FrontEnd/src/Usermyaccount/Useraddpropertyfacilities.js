...
const Useraddpropertyfacilities = () => {
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="card-body report-table">
                        ...
                        <center>
                                            <h2>Your Property Facilitites
                                            
                                            
                                     
                                </h2> <Link to="/addpropertyfacilities">Add Your Property Facilities</Link></center>
...

                                        {
                                            Propertyfacility.map((row,index)=>{
                                                ...
                                                <tr>
                                                     ...
                                                     <td>
                                                     <td><Link to={"/viewuserpropertyfacilities/"+row.property_facility_id} className="fa fa-eye fa-xl" style={{color:'blue'}}>
                                                                
                                                                </Link> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                <Link to={"/edituserpropertyfacilities/"+row.property_facility_id} className="fas fa-edit fa-xl" style={{color:'green'}} >
...
export default Useraddpropertyfacilities
