...
const Edituserpropertyinquiryresponse = () => {
                                        ...
                                        <div className="user-name media">
                                            ...
                                            <form method='POST' onSubmit={handleForm} className="row gx-3">
                                                <div className="form-group col-md-12 col-sm-6">
                                                        ...
                                                        <input type="text" value={status} onChange={(e) => setstatus(e.target.value)} className="form-control" placeholder="enter your Projectname" name='title' required=""></input>
...
export default Edituserpropertyinquiryresponse
