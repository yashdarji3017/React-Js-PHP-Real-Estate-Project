...
const Addproperty = () => {
    ...
    var [parkingError,setparkingError] = useState("");
    var [isavailableError, setisavailableError] = useState("");
    var [isapproveError,setisapproveError] = useState("");
    var [isactiveError,setisactiveError] = useState("");
    var [build_dateError,setbuild_dateError] = useState("");
    var [projectidError,setprojectidError] = useState("");
    var [useridError,setuserIdError] = useState("");
    ...
    var [property_photoError,setproperty_photoError] = useState("");
    ...
    postParams.append("id",stateid);
     ...
     const checkdata = () => {
        ...
        postParams.append("userid",localStorage.getItem("userid"));
            ...
            axios.post(configData.SERVER_URL+"update/checkpackage.php",postParams).then((response)=>{
                if(response.status==200)
                {
                  if(response.data=="no")
                  {
                    alert("Your Property limit exceed. Please Purchase Package.");
                    navigate("/package");
                  }
                }
            });
...
const handleProjectChange = (e) =>{
    ...
    setprojectid(projectid);
        ...
        const handleForm = (e) => {
            ...
            {
                setformvalid(false);
                setuserIdError("Please Select User")
            }
            if(categoriesid=="")
            {
                setformvalid(false);
            ...
            {
                setformvalid(false);
                setproperty_photoError("Please Select Property Photo")
            }
            ...
            && landmark!=="" && area!=="" && furnished!=="" && floors!=="" && parking!=="" && build_date!=="" &&  categoriesid!=="" && stateId!=="" && citiesId!=="" && property_photo!=="")
            {
           ...
           setformvalid(true)
            ...
            axios.post(configData.SERVER_URL+"addProperty.php",postParams).then((response)=>{
            ...
            if(response.status == 200)
                {
                    ...
                    alert(result)
                     ...
                     { 
                        window.scrollTo(0, 0);
                        setSuccessMessage("Propert Inserted successfully!");
                       // alert("Data Inserted");
                        }
                          ...
                          <form method='POST' onSubmit={handleForm} className="row gx-3">
                                            ...
                                            categories.map((row,index)=>{
                                                ...
                                                <select className="form-control" onChange={(e)=>setproperty(e.target.value)}>
                                                    <option >Please select Sell/Rent </option>
                                            ...
                                            <div className="form-group col-md-6 col-sm-6">
                                                ...
                                                {(formvalid===false && property_photo=="")&&(<><p className="error">{property_photoError}</p></>)}    
                                            ...
                                            <input type="checkbox" value="EmergencyExit" onChange={(e) =>  setexit(e.target.value)}   ></input>
                                             &nbsp;<label>Emergency Exit</label>
                                            </div> 
                                            <div className="form-group col-md-4 col-sm-4"> 
                                            <input type="checkbox" value="CCTV" onChange={(e) =>  setcctv(e.target.value)}   ></input>
                                             &nbsp;<label>CCTV</label>
                                            </div>  
                                            <div className="form-group col-md-4 col-md-4"> 
                                            <input type="checkbox"  value="FreeWi-Fi" onChange={(e) =>  setwifi(e.target.value)}   ></input>
                                             &nbsp;<label>Free Wi-Fi</label>
                                            </div> 
                                            <div className="form-group col-md-4 col-md-4"> 
                                            <input type="checkbox"  value="FreeParking" onChange={(e) =>  setparking(e.target.value)}   ></input>
                                             &nbsp;<label>Free Parking In The Area</label>
                                            </div> 
                                            <div className="form-group col-md-4 col-md-4"> 
                                            <input type="checkbox"  value="Aircondition" onChange={(e) =>  setair(e.target.value)}   ></input>
                                             &nbsp;<label>Air Conditioning</label>
                                               
                                            </div> 
                                            <div className="form-group col-md-4 col-md-4"> 
                                            <input type="checkbox"  value="SecurityGuard" onChange={(e) =>  setsecurity(e.target.value)}   ></input>
                                             &nbsp;<label>Security Guard</label>
                                            </div> 
                                            <div className="form-group col-md-4 col-md-4"> 
                                            <input type="checkbox"  value="Terrace" onChange={(e) =>  setterrace(e.target.value)}   ></input>
                                             &nbsp;<label>Terrace</label>
                                            </div> 
                                            <div className="form-group col-md-4 col-md-4"> 
                                            <input type="checkbox"  value="ElevatorLift" onChange={(e) =>  setlift(e.target.value)}   ></input>
                                             &nbsp;<label>Elevator Lift</label>
                                            </div> 
                                            <div className="form-group col-md-4 col-md-4"> 
                                            <input type="checkbox"  value="Balcony" onChange={(e) =>  setbalcony(e.target.value)}   ></input>
                                             &nbsp;<label>Balcony</label>
                                            </div> 
                                    ...
                                    localStorage.getItem("isclientlogin") && 
                                            <div className="form-btn">
                                                    ...
                                                    <button type="button" className="btn btn-pill btn-dashed color-1">Cancel</button>
                                                </div>
                                                 }</form>
