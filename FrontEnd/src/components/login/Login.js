...
const Login = () => {
    ...
    const handleForm = (e) => {
        ...
        if (password == "") {
            ...
            axios.post(configData.SERVER_URL + "clientlogin.php", postParams).then((response) => {
                if (response.status == 200)
                 {
                    ...
                    if (result["status"] == "yes") {
                        ...
                        localStorage.setItem("name", result["userdata"]["firstname"]+" "+  result["userdata"]["lastname"]);
                        localStorage.setItem("type", result["userdata"]["type"]);
                        if(result["userdata"]["type"]=="Agent")
                        {
                            navigate("/agentmyprofile");
                        ...
                        <div className="col-lg-6">
                            <div className="log-in">
                                ...
                                <form method='POST' onSubmit={handleForm} className="row gx-3">
                                    ...
                                    <label><Link to="/architectlogin"><b>Login As Architect </b></Link></label>
                                    <label><Link to="/forgotpassword" ><b>Forgot Password Not For Architect</b></Link></label>
