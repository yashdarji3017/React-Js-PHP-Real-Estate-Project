...
const ArchitectForgotPassword = () => {
    ...
    const handleclick=(e)=>{
        ...
        axios.post(configData.SERVER_URL+"forgotpasswordarchitect.php",postParams).then((response)=>{
...
export default ArchitectForgotPassword;
