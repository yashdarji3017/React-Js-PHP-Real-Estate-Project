...
const Agentarticles = () => {
    ...
    const getAllArtilces = () => {
        ...
        axios.post(configData.SERVER_URL+"getAgentarticles.php",postParams).then((response)=>{
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="card-body report-table">
                        <center><h2>Agent Articles</h2>
                        <Link to="/agentaddarticles">Add Agent Articles</Link>
                        </center>
                        {successMessage!="" && <div className="alert alert-success">
                                ...
                                <div className="table-responsive transactions-table">
                                            <table className="table table-bordernone m-0">
                                                <thead>
                                                    <tr>
                                                        <th className="light-font">Agent Name</th>
                                            ...
                                            allarticles.map((row,index)=>{
                                                return(
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <Link to={"/viewagentarticles/"+row.article_id} className="fa fa-eye fa-xl" style={{color:'blue'}}>
                                                                
                                                                </Link> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            <Link to={"/editagentarticles/"+row.article_id} className="fas fa-edit fa-xl" style={{color:'green'}} >
