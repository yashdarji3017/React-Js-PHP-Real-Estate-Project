...
const Editagentprofile = () => {
    ...
    const handleForm = (e) => {
        ...
        if(firstName!=="" && lastName!=="" && contact!=="" && email!=="" && about!=="" && aadhar_no!=="" && gender!==""
        && type!=="" && citiesId!=="" && stateId!=="" && address!=="" && contact.length==10 && aadhar_no.length==12 )
        {
            setformvalid(true)
        var postParams = new FormData();
                                    ...
                                    <div className="common-card">
                                        <div className="user-name media">
                                            ...
                                            <form method='POST' onSubmit={handleForm}  className="row gx-3">
                                                    ...
                                                    <div className="form-group col-md-4 col-sm-6">
                                                        <label>Contact</label>
                                                        <input type="number" value={contact} onChange={(e) => setcontact(e.target.value)} className="form-control" placeholder="enter your contact"    ></input>
                                            ...
                                            allcities.map((row,index)=>{
                                             ...
                                             <div className="form-group col-md-6 col-sm-6">
                                                    ...
                                                    <div className="form-group col-md-6 col-sm-6">
                                                        ...
                                                        <input type="text" value={aadhar_no} onChange={(e) =>  setaadhar_no(e.target.value)} className="form-control" placeholder="enter your Aadhar card No" name="aadhar_no" ></input>
                                                        {(formvalid===false && aadhar_no=="")&&(<><p className="error">{aadhar_noError}</p></>)}
                                                        {(formvalid===false && aadhar_no!="" && aadhar_no.length<10 && <><p className="error">Please Enter Valid Aadhar Number</p></>)}
