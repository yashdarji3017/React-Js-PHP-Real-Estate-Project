...
const Addarchitectproject = () => {
    ...
    var [photo_file_projectError,setphoto_file_projectError] = useState("");  
    var [pdf_fileError,setpdf_fileError] = useState("");
    ...
    const handleForm = (e) => {
        e.preventDefault();
                ...
                if(photo_file_project=="")
                {
                    setformvalid(false);
                    setphoto_file_projectError("Please Select Photos")
                }
                 if(pdf_file=="")
                {
                    setformvalid(false);
                    setpdf_fileError("Choose PDF File")
                } 
                ...
                && area!=="" && contect_number!=="" && email!=="" && book!=="" && photo_file_project!=="" && pdf_file!=="" && architechid!=="" && citiesId!=="" && stateId!=="" 
                ...
                axios.post(configData.SERVER_URL+"addProject.php",postParams).then((response)=>{
                ...
                if(response.status == 200)
                    {
                        ...
                        if(result=="Yes")
                            { 
                        window.scrollTo(0, 0);
                        setSuccessMessage("Project Inserted successfully!");
                    // alert("Data Inserted");
                        }
                        else
                        {
                                    ...
                                    {successMessage!="" && <div className="alert alert-success">
                                            ...
                                            <form method='POST' onSubmit={handleForm} className="row gx-3">
                                                    ...
                                                    <div className="form-group col-md-6 col-sm-6">
                                                        ...
                                                        <input type="text" value={title} onChange={(e) => settitle(e.target.value)} className="form-control" placeholder="enter your Project Title" name='title' required=""></input>
                                            ...
                                            <div className="form-group col-md-6 col-sm-6">
                                                ...
                                                {(formvalid===false && photo_file_project=="")&&(<><p className="error">{photo_file_projectError}</p></>)}
                                            ...
                                            <div className="form-group col-md-6 col-sm-6">
                                                ...
                                                {(formvalid===false && pdf_file=="")&&(<><p className="error">{pdf_fileError}</p></>)}
                                            ...
                                            <div className="form-group col-md-6 col-sm-6">
                                                        ...
                                                        <input value={enrollment} onChange={(e) => setenrollment(e.target.value)}type="text" className="form-control" placeholder="enrollment no" name='enrollment' required=""></input>
                                            ...
                                            <div className="form-group col-sm-6">
                                                ...
                                                <input type="radio" name="Booked" value="Yes" onChange={(e) =>  setBook(e.target.value)}></input>
                                                <label for=" Yes">Yes</label>&nbsp; &nbsp;
                                                <input type="radio" name="Booked" value="No" onChange={(e) => setBook(e.target.value)}></input>
...
export default Addarchitectproject
