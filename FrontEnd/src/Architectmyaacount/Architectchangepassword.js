...
const Architectchangepassword = () => {
    ...
    const handleForm = (e) => {
        ...
        axios.post(configData.SERVER_URL+"architectchangepassword.php",postParams).then((response)=>{
...
export default Architectchangepassword
